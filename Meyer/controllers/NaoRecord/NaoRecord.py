...
class Nao (Supervisor):
    ...
    def recordMotion(self, motion, fileName):
        if not self.toRecord[fileName] and self.doRecording and not os.path.isfile(self.path + fileName + '.mp4'):
            self.movieStartRecording(self.path + fileName + '.mp4', 854, 480, 1337, 100, 1, False)
    ...
    def __init__(self):
        ...
        #self.bodyColours = {
        #'Blue':[0, 0.592157, 0.886275],
        #'BlueDark':[0, 0, 0.498039],
        #'Green':[0, 0.866667, 0],
        #'GreenDark':[0, 0.572549, 0],
        #'Yellow':[1, 1, 0],
        #'YellowDark':[0.5, 0.5, 0],
        #'Red':[1, 0, 0],
        #'RedDark':[0.369, 0.047, 0.047],
        #'White':[1, 1, 1],
        #'Black':[0, 0, 0],
        #'Grey':[0.5, 0.5, 0.5]}
        self.eyeColours = {
    ...
    def doneAlready(self, main, secondary, eye):
        ...
        if os.path.isdir(self.path):
            ...
            return False
                #print(self.path + key + '.mp4' + ' -> ' + str(os.path.isfile(self.path + key + '.mp4')))
                ...
                for secColor, secValue in self.bodyColours.items():
                    ...
                    for eyeColor, eyeValue in self.eyeColours.items():
                        ...
                        if not self.doneAlready(mainColor, secColor, eyeColor):
                            ...
                            print('Recording with {} has already been done.\n\n'.format(mainColor, secColor, eyeColor))
                            pass
